...
app.config(function($routeProvider) {
    $routeProvider.when("/one/:paramValue", { templateUrl: "one.html" });
...
app.controller("oneCtrl", [
    ...
    function($scope, $http, $routeParams) {
        $scope.myRouteParamValue = $routeParams.paramValue;
    }
]);
    ...
    function($scope, $http) {
        ...
        $scope.imageData = [{
            ...
            },
            {
                ...
                captions: [
                    "Sample Social Media Application : Implementation using AWS services",
                ],
            },
            {
