...
app.controller('SalesController', ['$scope', '$interval', '$http', '$log',
    function ($scope, $interval, $http, $log) {
        ...
        // $http.get("http://localhost:3000/relation-graph-representation/combined-person-relation/10OCT2020-00006-Shri-Shankar-sah").then(function (response) {
...
app.directive('linearChart', function ($parse, $window) {
    return {
        restrict: 'EA',
        template: "<svg width='1250' height='200'></svg>",
