...
!(function (a) {
  ...
  (function (a) {
    ...
    (b.prototype = {
      ...
      values: function (b) {
        for (
          var c = a.extend({}, this.options, b), d = [], e = null, f = 0, g = 0;
          g < this.cells.length;
          g++
        )
          if (((e = this.cells[g].value(c)), 1 === this.cells[g].colSpan()))
    ...
    (b.prototype = {
      ...
      headings: function () {
        return this.rows.length > 0 && !this.options.headings
          ? this.rows[0].values({ extractor: null, textExtractor: null })
      ...
      ignoreRow: function (a, b) {
        return (
          ...
          (this.options.ignoreHiddenRows && !a.$element.is(":visible")) ||
