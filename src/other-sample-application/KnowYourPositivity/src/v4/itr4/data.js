...
import RajMistiry from "./RajMistiry.js";
...
const RawData = [
  RajMistiry.prepareStructure({
    ...
    sentencesTexts: [
      "**Stay calm** to clear mind with unnecessary things and get ready to **review** and **prioritize** actionables for today. So that you could **revise** and **practice** some meaningful today. Don't forget to **retrospect** by EOD.",
    ...
    subsectionsArr: [
      RajMistiry.prepareStructure({
        sectionName:
          "[stay calm, review, prioritise, revise, practice, retrospect] का उपयोग करके विभिन्न दृष्टिकोणों के लिए 2-2 वाक्य",
        sentencesTexts: [
          `
### **शांत रहें (Stay Calm)**  
- जब कोई समस्या आए, तो घबराने की बजाय **शांत रहें** और समाधान पर ध्यान दें।  
- **शांत मन** से लिए गए निर्णय अधिक प्रभावी और टिकाऊ होते हैं।  
    `,
          `
### **समीक्षा करें (Review)**  
- किसी भी कार्य को पूरा करने के बाद, उसकी **समीक्षा करें** ताकि सुधार की गुंजाइश समझ आए।  
- परीक्षा से पहले अपनी तैयारियों की **समीक्षा करें**, यह आत्मविश्वास बढ़ाता है।  
    `,
          `
### **प्राथमिकता तय करें (Prioritise)**  
- समय सीमित होता है, इसलिए कार्यों की **प्राथमिकता तय करें** और महत्वपूर्ण कार्य पहले करें।  
- सफलता पाने के लिए यह जरूरी है कि हम सही चीज़ों को **सही समय पर प्राथमिकता दें**।  
    `,
          `
### **संशोधित करें (Revise)**  
- परीक्षा से पहले विषयों को **संशोधित करें**, ताकि याद किया हुआ लंबे समय तक बना रहे।  
- कोई भी दस्तावेज़ सबमिट करने से पहले उसे एक बार **संशोधित करना** आवश्यक होता है।  
    `,
          `
### **अभ्यास करें (Practice)**  
- किसी भी कौशल में निपुण बनने के लिए नियमित **अभ्यास करना** जरूरी है।  
- **अभ्यास ही सफलता की कुंजी** है, इसलिए निरंतर प्रयास करें।  
    `,
          `
### **पुनरवलोकन करें (Retrospect)**  
- अपनी गलतियों से सीखने के लिए समय-समय पर **पुनरवलोकन करें**।  
- सफलता और असफलता दोनों का **पुनरवलोकन करना** आवश्यक होता है ताकि आगे बेहतर किया जा सके।  
    `,
        ],
        subsectionsArr: [
          RajMistiry.prepareStructure({
            sectionName: "विभिन्न दृष्टिकोण",
            sentencesTexts: [
              `
### **1️⃣ Problem-Solving**  
- **शांत रहें** और समस्या को गहराई से समझने की कोशिश करें, जल्दबाजी में समाधान न निकालें।  
- समस्या का **समीक्षण करें** और उसे छोटे-छोटे हिस्सों में विभाजित कर प्राथमिक कारण पहचानें।  
`,

              `
### **2️⃣ Decision-Making**  
- किसी भी निर्णय से पहले **पुनरावलोकन करें** कि सभी विकल्पों को सही से समझा गया है या नहीं।  
- जो सबसे महत्वपूर्ण है उसे **प्राथमिकता दें** और तर्कसंगत निर्णय लें।  
`,

              `
### **4️⃣ Innovation & Creativity**  
- नए विचारों पर काम करने से पहले पुरानी रणनीतियों का **पुनरावलोकन करें** और जरूरत के अनुसार संशोधित करें।  
- निरंतर **अभ्यास करें**, क्योंकि रचनात्मकता अभ्यास से ही निखरती है।  
`,

              `
### **5️⃣ Leadership & Teamwork**  
- एक अच्छा नेता बनने के लिए **शांत रहें** और दूसरों की राय को सम्मान दें।  
- टीम के प्रदर्शन का समय-समय पर **पुनरावलोकन करें** और उसे बेहतर बनाने की रणनीति बनाएं।  
`,

              `
### **6️⃣ Communication Skills**  
- अपनी बात स्पष्ट और आत्मविश्वास से कहने के लिए **नियमित अभ्यास करें**।  
- बातचीत के दौरान किसी भी गलतफहमी से बचने के लिए अपनी कही बातों का **समीक्षण करें**।  
`,

              `
### **7️⃣ Personal Growth & Mindset**  
- अपने लक्ष्यों को पाने के लिए **प्राथमिकता तय करें** और उसी अनुसार कार्य करें।  
- हर अनुभव के बाद **पुनर्विचार करें** कि आपने क्या सीखा और इसे कैसे बेहतर कर सकते हैं।  
`,

              `
### **9️⃣ Learning from Failures**  
- असफलता के बाद **शांत रहें**, क्योंकि यह सीखने का अवसर है।  
- अपनी गलतियों का **पुनरावलोकन करें** और अगली बार सुधार करने की योजना बनाएं।  
`,

              `
### **🔟 Building Strong Habits**  
- किसी भी अच्छी आदत को अपनाने के लिए **नियमित अभ्यास करें** और खुद को ट्रैक करें।  
- समय-समय पर अपनी आदतों का **पुनरावलोकन करें** और यह देखें कि वे आपके लक्ष्यों के अनुकूल हैं या नहीं।  
`,
            ],
          }),
        ],
