app.factory("InterviewManagementServices", [
  ...
  function ($http, $log, $routeParams, AppConfig) {
    ...
    InterviewManagementServices.fetchQuestionsList = function (linkedCategoryID) {
      return $http.get(AppConfig.interviewMgmtServices + "/categories/" + linkedCategoryID + "/questions");
    };

    InterviewManagementServices.markRead = function (linkedCategoryID, linkedQuestionID) {
      return $http.put(AppConfig.interviewMgmtServices + "/categories/" + linkedCategoryID + "/questions/" + linkedQuestionID + "/markread");
    };

    InterviewManagementServices.markPrivate = function (linkedCategoryID, linkedQuestionID) {
      return $http.put(AppConfig.interviewMgmtServices + "/categories/" + linkedCategoryID + "/questions/" + linkedQuestionID + "/markprivate");
    };

    InterviewManagementServices.fetchAnswersList = function (linkedCategoryID, linkedQuestionID) {
      return $http.get(AppConfig.interviewMgmtServices + "/categories/" + linkedCategoryID + "/questions/" + linkedQuestionID + "/answers");
    };

    /**Fetch Category, Question, Answer object on basis of given ID*/

    InterviewManagementServices.fetchCategory = function (catID) {
      return $http.get(AppConfig.interviewMgmtServices + "/categories" + "/" + catID);
    };

    InterviewManagementServices.fetchQuestionForCategory = function (catID, questionID) {
      return $http.get(AppConfig.interviewMgmtServices + "/categories" + "/" + catID + "/questions/" + questionID);
    };

    InterviewManagementServices.fetchAnswerForQuestion = function (catID, questionID, answerID) {
      return $http.get(AppConfig.interviewMgmtServices + "/categories" + "/" + catID + "/questions/" + questionID + "/answers/" + answerID);
    };

    /**Save Category, Question, Answer */

    InterviewManagementServices.saveCategory = function (categoryObj) {
      var req = {
        method: "POST",
    ...
    InterviewManagementServices.saveQuestion = function (questionObj, catID) {
      var req = {
        method: "POST",
    ...
    InterviewManagementServices.saveAnswer = function (answerObj, catID, questionID) {
      var req = {
        method: "POST",
    ...
    InterviewManagementServices.updateCategory = function (categoryObj) {
      var req = {
        method: "PUT",
        url: AppConfig.interviewMgmtServices + "/categories",
        headers: {
    ...
    InterviewManagementServices.updateQuestion = function (questionObj, catID) {
      var req = {
        method: "PUT",
        url: AppConfig.interviewMgmtServices + "/categories/" + catID + "/questions",
        headers: {
    ...
    InterviewManagementServices.markReadQuestion = function (questionObj, catID, questionID) {
      var req = {
        method: "PUT",
    ...
    InterviewManagementServices.updateAnswer = function (answerObj, catID, questionID) {
      var req = {
        method: "PUT",
        url: AppConfig.interviewMgmtServices + "/categories/" + catID + "/questions/" + questionID + "/answers",
        headers: {
